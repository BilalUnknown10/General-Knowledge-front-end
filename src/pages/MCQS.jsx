  ...
  return (
    <div className=" relative p-5 md:p-10 bg-green-100 h-[90vh] flex justify-center flex-col items-center">
      {userDetails?.submittedAnswers?.length === allQuestions?.length && (
        <div>
        <button onClick={downloadMcqs} className="text-xl bg-green-500 px-10 py-2 text-white font-bold rounded-md absolute md:top-10 md:bottom-auto bottom-18 md:right-10 cursor-pointer">Download All MCQS</button>
       </div>
      )}
