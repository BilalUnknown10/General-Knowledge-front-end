...
function FirstSection() {
  return (
    <>
      <div className='flex md:flex-row flex-col-reverse m:justify-between md:p-10 py-5 gap-5 '>
        <div className="description md:pt-20 basis-1/2 relative">
            ...
            <Link to={'/mcqs'}>
            <button className=' w-full my-5 md:w-1/2 font-bold md:text-2xl md:absolute md:bottom-0 py-4 px-10 rounded-md shadow-md cursor-pointer bg-[var(--primary)] text-white hover:bg-green-600 transition-all duration-700 ease-in-out hover:w-full'>Take Quiz</button>
            </Link>
        </div>
