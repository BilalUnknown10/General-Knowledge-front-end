...
function AboutUs() {
  ...
  {/* Column 1 */}
  <div className=" md:w-1/3 w-full p-4 rounded-xl bg-[var(--primary)] text-white shadow-md flex flex-col cursor-pointer  hover:shadow-2xl">
  ...
  {/* Column 2 */}
  <div className="md:w-1/3 w-full p-4 rounded-xl shadow-md bg-[var(--primary)] text-white flex flex-col cursor-pointer hover:shadow-2xl">
